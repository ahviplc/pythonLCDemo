...
"""
一个简单的博客网站
技术栈：boostrap + flask + sqlalchemy + sqlite3
Version: 1.0
Author: LC
DateTime: 2019年1月3日11:30:52
一加壹博客最Top-一起共创1+1>2的力量！~LC
LC博客url: http://oneplusone.top/index.html
"""

SECRET_KEY = 'This is my key'
DATABASE = './video_flask_sqlite3.db'
app = Flask(__name__)
...
def add_entries():
    ...
    g.db.execute('insert into entries (title,text,now,name) values (?, ?,?,?)',
                 [request.form['title'], request.form['text'], now, str(session['user'])])
    g.db.commit()
