...
"""
目前使用的是这个
python_report_hourly_app_king3_pro.py.py 加强版本3_pro 优化sql 再次优化小时报表 封装了小时报表对象类以及将取自动递增流水方法提取到工具db_utils文件中,集成监听所有的print到log日志的封装类
...
if __name__ == '__main__':
    ...
    # sys.stdout = PrintLogger('python_report_hourly_app_king3_pro.py.log')  # 监听所有的print到log日志 封装类 如不需要打印所有输出print的log日志，隐掉这段即可
