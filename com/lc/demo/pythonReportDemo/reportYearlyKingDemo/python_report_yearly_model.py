...
"""
python_report_yearly_model.py
年报表 封装类
Version: 1.0
Author: LC
DateTime: 2019年3月20日09:56:56
UpdateTime:
...
class ReportYearlyModel:
    ...
    def __init__(self, sry_org_id=sry_org_id,
                 sry_id=sry_id,
                 rtu_no=rtu_no,
                 ...
                 temp_out=temp_out,
                 rssi=rssi,
                 sry_status=sry_status):
        self.sry_org_id = sry_org_id
        self.sry_id = sry_id
        self.rtu_no = rtu_no
