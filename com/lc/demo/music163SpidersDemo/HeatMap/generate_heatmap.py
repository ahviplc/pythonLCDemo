...
from urllib.request import quote, urlopen, string
...
def generate_map(loc_counts):
    ...
    <head>
        ...
        //这样也可以: <script type="text/javascript" src="http://api.map.baidu.com/library/Heatmap/2.0/src/heatmap.js"></script>
        <title>热力图功能示例</title>
        <style type="text/css">
    ...
    with open("music163.html", 'a', encoding='utf-8') as f:
        f.write(header)
