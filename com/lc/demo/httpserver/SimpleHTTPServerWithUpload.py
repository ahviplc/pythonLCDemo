...
备注:python 一个简易的文件服务器，支持上传文件到根目录
Version: 1.0
Author: LC
DateTime: 2019年12月2日10:49:03
UpdateTime:
...
# 使用说明:
# 命令行使用实例:
# -> python SimpleHTTPServerWithUpload.py --bind localhost 8086
# Serving HTTP on localhost port 8086 (http://localhost:8086/) ...


# -> python SimpleHTTPServerWithUpload.py -h
# usage: SimpleHTTPServerWithUpload.py [-h] [--bind ADDRESS] [port]
#
...
#
# -> python SimpleHTTPServerWithUpload.py --bind localhost
