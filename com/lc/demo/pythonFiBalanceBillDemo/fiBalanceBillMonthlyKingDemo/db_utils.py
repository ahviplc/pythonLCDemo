...
db_utils.py
工具类(启用) for 月 后付费结算单/付款通知单
Version: 1.0
Author: LC
DateTime: 2019年4月9日15:20:17
UpdateTime: 2019年4月9日15:20:22
...
def insert_sys_serial_no(db, ssn_org_id, ssn_key_name, ssn_year, ssn_month):
    ...
    data = [{"ssn_org_id": ssn_org_id, "ssn_key_name": ssn_key_name, "ssn_year": ssn_year, "ssn_month": ssn_month,
             "ssn_value": "0000000000", "ssn_key_type": "2", "ssn_key_description": ssn_year + ssn_month + "月账单"}]
