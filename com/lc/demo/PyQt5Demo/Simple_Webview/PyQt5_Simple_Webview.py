...
"""
PyQt5_Simple_Webview.py
PyQt5程序样例:实现一个简单的浏览器-并注入 Javascript 脚本实现自动化操作
Version: 1.0
Author: LC
DateTime: 2019年1月11日16:20:44
...
if __name__ == '__main__':
    ...
    # 设置窗口标题
    b.setWindowTitle('My Simple Browser By LC')
    # 设置窗口图标
    b.setWindowIcon(QIcon('icons/penguin.png'))
    # 设置窗口大小900*600
    b.resize(900, 600)

    b.load('http://www.oneplusone.vip')  # 一加壹博客最Top
    sys.exit(app.exec_())
